...
const Services_ = () => {
    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="text-center">
            <h2 className="text-3xl font-bold leading-tight text-gray-900 sm:text-4xl xl:text-5xl font-pj">Fair Avenue Venture's Services</h2>
            <p className="mt-4 text-base leading-7 text-gray-600 sm:mt-8 font-pj"> We offer a diverse range of services tailored to meet various needs. Our Shipping Agency ensures efficient and reliable shipping solutions, while our Real Estate services focus on building and providing houses and apartments for rent, lease, or sale. In the Mining sector, we specialize in gold dealership, delivering trusted and secure transactions. Additionally, our Trading services facilitate seamless import and export operations, catering to both local and international markets.</p>
        </div>
